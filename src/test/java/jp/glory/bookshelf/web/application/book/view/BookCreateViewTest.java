...
public class BookCreateViewTest {

	private static BookCreateView sut = null;
	...
	public static class 共通設定のテスト {
		...
		public void setUp() {
			...
			sut = new BookCreateView(new Book());
		}
		...
		public void getContentNameでコンテンツ名が返却される() {
			...
			assertThat(sut.getContentName(), is(ContentName.BOOK_CREATE_VIEW));
		}
	}
	...
	public static class 本を指定した場合 {
		...
		public void setUp() {
			...
			sut = new BookCreateView(TestTools.createBook());
		}
